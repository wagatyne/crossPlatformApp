// crossPlatformApp.cpp : Defines the entry point for the application.
//

#include "pch.h"
#include "crossPlatformApp.h"
...
// Global Variables:
constexpr PCWSTR windowTitle = L"crossPlatformApp";
constexpr PCWSTR mainComponentName = L"crossPlatformApp";
